...
namespace UnityServiceLocator
{
    public class ServiceLocator : MonoBehaviour
    {
        ...
        private void Start() => Debug.Log("ServiceLocation Start");
        ...
        public ServiceLocator Register<T>(T service, bool overrideExisting = false)
        {
            services.Register(service, overrideExisting);
            return this;
        }
        ...
        /// <param name="service">The service to register.</param>  
        /// <returns>The ServiceLocator instance after registering the service.</returns>
        public ServiceLocator Register(Type type, object service, bool overrideExisting = false)
        {
            services.Register(type, service, overrideExisting);
            return this;
        }
